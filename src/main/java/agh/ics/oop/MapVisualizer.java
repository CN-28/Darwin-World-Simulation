...
public class MapVisualizer {
     ...
     * @param map
     */
    public MapVisualizer(IWorldMap map, Vector2d jungleLowerLeft, Vector2d jungleUpperRight) {
        this.map = map;
    ...
    private String drawObject(Vector2d currentPosition) {
        ...
        if (this.map.isOccupied(currentPosition)) {
            ...
            if (object != null) {
                ...
                if (currentPosition.follows(this.jungleLowerLeft) && currentPosition.precedes(this.jungleUpperRight))
                    result = "D";
                else
                    result = EMPTY_CELL;
            }
